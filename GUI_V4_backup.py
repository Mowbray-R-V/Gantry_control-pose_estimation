...
def M_EOT_Buttons():
    global X_Plus
    X_Plus= Button(F5, text="X+", bg="blue", font="bold, 15", relief=RAISED, borderwidth=10)
    X_Plus.place(x=300, y=20, height=50, width=80)
    global X_Minus
    X_Minus= Button(F5, text="X-", bg="blue", font="bold, 15", relief=RAISED, borderwidth=10)
    X_Minus.place(x=400, y=20, height=50, width=80)

    global Y_Plus
    Y_Plus= Button(F5, text="Y+", bg="green", font="bold, 15", relief=RAISED, borderwidth=10)
    Y_Plus.place(x=300, y=100, height=50, width=80)
    global Y_Minus
    Y_Minus= Button(F5, text="Y-", bg="green", font="bold, 15", relief=RAISED, borderwidth=10)
    Y_Minus.place(x=400, y=100, height=50, width=80)

    global Z_Plus
    Z_Plus= Button(F5, text="Z+", bg="red", font="bold, 15", relief=RAISED, borderwidth=10)
    Z_Plus.place(x=300, y=180, height=50, width=80)
    global Z_Minus
    Z_Minus= Button(F5, text="Z-", bg="red", font="bold, 15", relief=RAISED, borderwidth=10)
    Z_Minus.place(x=400, y=80, height=50, width=80)
...
def ROI():
    ...
    global app1
    app1= Rec_Draw2.ExampleApp1(root)
    app1.pack()
    global Roi_msg
...
##LEFT SIDE FRAME
F1= Frame(root, bg='gray', width=550)
...
F3= Frame(root, bg='white', height=200)
