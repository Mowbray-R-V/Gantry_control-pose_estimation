...
def Save_bgr_depth():
    # Save_BGR_DEPTH_Frame.save_frames()
    # cam=RealsenseCamera()
    global intrinsics
    global depth
...
def EOT_Option():
    global B12
    B12= Button(F5, text="Manual EOT", bg="yellow", font="bold, 12", relief=RAISED, borderwidth=10, command=lambda:[ B13.destroy(), MEOT_col_chng(), M_EOT_Buttons()]) 
...
def M_EOT_Buttons():
    #varLabe=IntVar()
    global X_Plus
    X_Plus= Button(F5, text="X+", bg="red", font="bold, 15", relief=RAISED, borderwidth=10)
    X_Plus.place(x=300, y=20, height=50, width=80)
    global X_Minus
    X_Minus= Button(F5, text="X-", bg="red", font="bold, 15", relief=RAISED, borderwidth=10)
    X_Minus.place(x=400, y=20, height=50, width=80)

    global Y_Plus
    Y_Plus= Button(F5, text="Y+", bg="green", font="bold, 15", relief=RAISED, borderwidth=10, command=guicode.set_button3_state)
    Y_Plus.place(x=300, y=100, height=50, width=80)
    global Y_Minus
    Y_Minus= Button(F5, text="Y-", bg="green", font="bold, 15", relief=RAISED, borderwidth=10,command=guicode.set_button4_state)
    Y_Minus.place(x=400, y=100, height=50, width=80)

    global Z_Plus
    Z_Plus= Button(F5, text="Z+", bg="gold", font="bold, 15", relief=RAISED, borderwidth=10)
    Z_Plus.place(x=300, y=180, height=50, width=80)
    global Z_Minus
    Z_Minus= Button(F5, text="Z-", bg="gold", font="bold, 15", relief=RAISED, borderwidth=10)
    Z_Minus.place(x=400, y=180, height=50, width=80)

    global Quit
    Quit=Button(F5, text="QUIT", bg="red",font="bold, 15", relief=RAISED, borderwidth=10 )
